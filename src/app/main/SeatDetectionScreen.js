...
const SeatDetectionScreen = () => {
  ...
  useEffect(() => {
    if (detections.length > 0) {
      ...
      console.log('No seats detected');
      speak('No seats detected');
  ...
  return (
    <View style={styles.container}>
      ...
      {isProcessing && (
        <ActivityIndicator style={styles.processingIndicator} size="small" color="#4f46e5" />
      )}
    </View>
  );
};
...
export default SeatDetectionScreen;